...
fov1_data = readmatrix("fov_benchmark\gigamodel_fov_1_test_RecurrentPPO_1.csv");
fov2_data = readmatrix("fov_benchmark\gigamodel_fov_2_test_RecurrentPPO_1.csv");
fov5_data = readmatrix("fov_benchmark\gigamodel_fov_5_test_RecurrentPPO_1.csv");

fov_array = {fov1_data, fov2_data, fov5_data};
...
legend(["FoV=1", "FoV=2", "FoV=5"], Interpreter="tex");
