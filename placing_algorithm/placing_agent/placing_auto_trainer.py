...
fov = [1, 2, 5, 0.5] # 0.5 is likely to cuase a crash
...
placing_training("RAND-v0", folder=folder, run_name=run_name, save_interval=save_interval, depth_field=fov, length=length, total_timesteps=total_timesteps)
