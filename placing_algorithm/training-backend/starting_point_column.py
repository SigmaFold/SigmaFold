...
from library.shape_helper import path_to_shape_numbered, deserialize_path, deserialize_shape
...
def upload_best_starting_points(n=16):
    ...
    for row in shapes.iterrows():
        ...
        starting_point, direction = get_best_starting_point(shape_id)
        ...
        data = {"starting_point": starting_point, "starting_dir": direction, "shape_id": shape_id}
